...
## Run 22 ExecPlan — 2026-08-20 ([plan](plans/run-22.md); complete); Run 23 ([plan](plans/run-23.md); complete); Run 24 ([plan](plans/run-24.md); complete); Run 25 ([plan](plans/run-25.md); complete); Run 26 ([plan](plans/run-26.md); complete); Run 27 ([plan](plans/run-27.md); complete); Run 28 ([plan](plans/run-28.md); complete); Run 29 ([plan](plans/run-29.md); complete); Run 30 ([plan](plans/run-30.md); complete); Run 31 ([plan](plans/run-31.md); complete)
